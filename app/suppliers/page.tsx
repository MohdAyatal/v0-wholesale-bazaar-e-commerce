...
const suppliers = [
  {
    ...
    rating: 4.8,
    reviews: 245,
    description: 'Premium ethnic wear supplier specializing in traditional sarees and lehengas',
    yearsInBusiness: 15
  },
  {
    id: 2,
    ...
    rating: 4.6,
    reviews: 189,
    description: 'Leading manufacturer of casual wear and formal shirts',
    yearsInBusiness: 12
  },
  {
    id: 3,
    ...
    rating: 4.7,
    reviews: 167,
    description: 'Colorful and trendy kids clothing collection',
    yearsInBusiness: 10
  },
  {
    id: 4,
    ...
    email: 'bridal@dreams.com',
    verified: true,
    rating: 4.9,
    reviews: 312,
    description: 'Luxury bridal collections for weddings and special occasions',
    yearsInBusiness: 18
  },
  {
    id: 5,
  ...
  },
  {
    ...
    email: 'hello@threads.com',
    verified: true,
    rating: 4.7,
    reviews: 198,
    description: 'Handcrafted traditional wear with modern designs',
    yearsInBusiness: 14
  },
]
